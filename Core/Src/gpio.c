...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, USER_LED_Pin|SCREEN_RES_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = SCREEN_DC_Pin|SCREEN_CS_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  ...
  GPIO_InitStruct.Pin = BTN_OK_Pin|BTN_LEFT_Pin|BTN_RIGHT_Pin;
